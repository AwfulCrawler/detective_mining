...
simulate_ignore_mining <- function(alpha, gamma, theta, build_on_tip, N=50000){
    ...
    while (chain_length < N){
        ...
        if (x < alpha){
            ...
            #I think I'm rewarding the wins to the wrong category to be honest.
            #It's not necessary that an honest miner has extended the honest chain.  It could be that
            #the detective mining hashrate has extended the honest chain (but it doesn't matter because the honest chain
            #gets obliterated).  whew
            #This particular case looks to be ok.
